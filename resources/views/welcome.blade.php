...
<div x-data="{ mobileMenuOpen: false }" class="relative min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 overflow-x-hidden">
    ...
    <div class="absolute top-0 left-0 w-full h-[550px] md:h-[650px] overflow-hidden pointer-events-none">
        ...
        <div class="absolute inset-0 bg-gradient-to-b from-black/70 via-black/20 to-gray-50 dark:to-gray-950"></div>
    </div>
    ...
    <header class="fixed top-0 left-0 right-0 z-50 px-4 pt-4 md:pt-5 transition-all duration-300">
        ...
        <section class="pt-40 md:pt-52 flex flex-col items-center justify-center px-4 pb-16 md:pb-20">
            <div class="max-w-4xl w-full text-center transition-all duration-300">
                <h2 class="text-3xl md:text-5xl font-extrabold mb-4 leading-tight text-green-700 dark:text-green-500 drop-shadow-sm">
                    Selamat Datang di Portal Satu Data<br class="hidden md:block"> 
                    Kabupaten Sidoarjo
                </h2>
                <p class="text-sm md:text-lg mb-8 md:mb-10 max-w-2xl mx-auto text-gray-800 dark:text-gray-300 font-bold drop-shadow-sm">
                    Sumber data resmi untuk pembangunan daerah yang lebih berkualitas
                </p>
                
                <form x-data="{ target: '/datasets' }" :action="target" method="GET" class="relative max-w-2xl mx-auto flex flex-col md:flex-row items-center bg-white/95 dark:bg-gray-800/90 border border-white/50 dark:border-gray-600 rounded-2xl md:rounded-full shadow-2xl backdrop-blur-sm p-2 md:p-0 transition-all focus-within:ring-2 focus-within:ring-green-500">
