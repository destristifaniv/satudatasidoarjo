                        ...
                        <table class="w-full border-collapse table-fixed">
                            <tbody class="divide-y dark:divide-gray-800">
                                ...
                                <tr class="hover:bg-teal-50/50 dark:hover:bg-gray-800/50 transition-colors h-[52px]">
                                    ...
                                    <td class="text-center w-32 py-2">
                                        @if(isset($activities2024[$name]))
                                            <span class="px-2 py-1 bg-green-100 text-green-700 text-[8px] font-black uppercase rounded-md">On</span>
                                        @else
                                            <span class="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-400 text-[8px] font-black uppercase rounded-md">Off</span>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
